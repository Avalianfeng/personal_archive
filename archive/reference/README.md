# 归档参考 · archive/reference

> **状态**：历史管线与设计契约，**不描述当前架构**。
> **宪法**：[01-立意与分析体系.md](../../01-立意与分析体系.md) §5

当前架构见 [samples/persona-v1/](../../samples/persona-v1/) 多文件档案群。
...
| 文件 | 原用途 |
| --- | --- |
| [design-分析报告目录.md](./design-分析报告目录.md) | 产物 A 解释体 8 章 |
| [design-核心档案目录.md](./design-核心档案目录.md) | 产物 B 稳定层 |
| [design-时期快照目录.md](./design-时期快照目录.md) | 产物 B 动态层 |
| [design-人物档案目录.md](./design-人物档案目录.md) | 产物 B 索引 |
...
| [full-report-v1.md](./full-report-v1.md) | 更早实验 prompt |
| [generate_products.py](./generate_products.py) | L1 → A/B 脚本 |
