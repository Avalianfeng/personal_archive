...
import type { Answer, PersonalityVector } from '@renge-shenqian/shared';
import { finalizeVector } from '@renge-shenqian/shared';
import { loadQuestionBankSync } from './questionService.js';
import type { ChoiceOption } from '@renge-shenqian/shared';
