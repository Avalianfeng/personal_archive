...
> **关联**：[01-registries-规则真源/README.md](../01-registries-规则真源/README.md) · [prerequisites.md](../01-registries-规则真源/prerequisites.md) · [tags.md](../01-registries-规则真源/tags.md)
...
1. [01-registries-规则真源/README.md](../01-registries-规则真源/README.md)
2. [prerequisites.md](../01-registries-规则真源/prerequisites.md)（若审核 prerequisite）
3. [tags.md](../01-registries-规则真源/tags.md)（若审核 tag）
4. 现有 [prerequisites.yaml](../01-registries-规则真源/prerequisites.yaml) / [tags.yaml](../01-registries-规则真源/tags.yaml) 全文
